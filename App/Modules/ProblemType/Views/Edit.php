...
<form name="" method="post" action="" onsubmit="return check(this)" >
	problem_type_name <input type="text" name="problem_type_name" value="<?php echo $this->row->problem_type_name?>"><br>
	problem_type_detail <input type="text" name="problem_type_detail" value="<?php echo $this->row->problem_type_detail?>"><br>
