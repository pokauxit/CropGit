...
<form name="" method="post" action="" onsubmit="return check(this)" >
	symptom_name <input type="text" name="symptom_name" value="<?php echo $this->row->symptom_name?>"><br>
	symptom_detail <input type="text" name="symptom_detail" value="<?php echo $this->row->symptom_detail?>"><br>
